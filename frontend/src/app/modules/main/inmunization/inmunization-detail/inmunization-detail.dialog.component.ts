...
} from './inmunization-detail.component';
import {
  ActivatedRoute
} from '@angular/router';
import {
  InmunizationService
} from 'src/app/core/services/inmunization.service';
import {
  InmunizationHttpService
} from 'src/app/core/http/inmunization.http.service';
